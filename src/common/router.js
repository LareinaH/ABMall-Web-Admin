...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/adManage/teamSystem': {
      component: dynamicWrapper(app, ['teamSystem'], () => import('../routes/AdManage/TeamSystem')),
    },
    ...
    '/commodityManage/commodityAdd': {
      component: dynamicWrapper(app, ['commodityAdd'], () =>
    ...
    '/orderManage/orderList': {
      component: dynamicWrapper(app, ['orderList'], () =>
